        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="mb-8">
                <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between">
                    <div class="mb-4 sm:mb-0">
                        ...
                        <p class="mt-2 text-sm text-gray-600">Manage your business facilities and locations</p>
                    </div>
                    <div class="flex flex-col sm:flex-row gap-3">
                        ...
                        <a class="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md shadow-sm text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-colors duration-200"
                            href="{{ route('facilities.trashed') }}"
                            class="text-sm text-gray-700 hover:text-indigo-600 mr-4">
                            View Trash ({{ \App\Models\Facility::onlyTrashed()->count() }})
                        </a>
                            ...
                            <div class="ml-5 w-0 flex-1">
                                <dl>
                                    ...
                                    <dd class="text-lg font-medium text-gray-900">
                                        {{ $facilities->where('last_update_date', \Carbon\Carbon::today())->count() }}
                                    </dd>
                                </dl>
                            </div>
                        </div>
                        ...
                        <div class="flex items-center">
                            ...
                            <div class="ml-5 w-0 flex-1">
                                <dl>
                                    ...
                                    <dd class="text-lg font-medium text-gray-900">
                                        {{ $facilities->unique('street_address')->count() }}</dd>
                                </dl>
                            </div>
                        </div>
                    </div>
            ...
            <div class="lg:hidden space-y-4">
                @forelse ($facilities as $facility)
                    <div class="bg-white shadow rounded-lg p-6 hover:shadow-md transition-shadow duration-200">
                        <div class="flex items-start justify-between">
                            <div class="flex-1">
                                <h3 class="text-lg font-semibold text-gray-900 mb-2">{{ $facility->business_name }}</h3>
                ...
                @empty
                    <div class="bg-white shadow rounded-lg p-8 text-center">
                        ...
                        <h3 class="mt-2 text-sm font-medium text-gray-900">No facilities</h3>
            ...
            <div class="mb-4">
                <form action="{{ route('facilities.index') }}" method="GET">
                    <div class="flex items-center">
                        <input type="text" name="search" placeholder="Search by name or address..."
                            class="w-full md:w-1/3 px-4 py-2 border border-gray-300 rounded-l-md focus:outline-none focus:ring-2 focus:ring-indigo-500"
                            value="{{ request('search') }}">

                        <button type="submit"
                            class="px-4 py-2 bg-indigo-600 text-white font-semibold rounded-r-md hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2">
                            Search
                        </button>
                    </div>
                </form>
            ...
            <div class="hidden lg:block bg-white shadow overflow-hidden sm:rounded-md">
                <div class="px-4 py-5 sm:px-6 border-b border-gray-200">
                    <h3 class="text-lg leading-6 font-medium text-gray-900">Facility List</h3>
                    <p class="mt-1 max-w-2xl text-sm text-gray-500">A complete list of all your business facilities.
                    </p>
                </div>
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            @forelse ($facilities as $facility)
                                <tr class="hover:bg-gray-50 transition-colors duration-150">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="text-sm text-gray-900">{{ $facility->street_address }}</div>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap">
                            ...
                            @empty
                                <tr>
                                    <td colspan="4" class="px-6 py-12 text-center">
                                        ...
                                        <h3 class="mt-2 text-sm font-medium text-gray-900">No facilities</h3>
                                        <p class="mt-1 text-sm text-gray-500">Get started by creating a new facility.
                                        </p>
                                        <div class="mt-6">
                                            <a href="{{ route('facilities.create') }}"
                                                class="inline-flex items-center px-4 py-2 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">
